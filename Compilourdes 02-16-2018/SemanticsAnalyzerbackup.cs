...
namespace Compilourdes
{
    public class SemanticsAnalyzer
    {
        ...
        {
            /*string x = (string)lexTable.Rows[5].Cells[2].Value;
            ...
            for (int i = 0; i < lexTable.Rows.Count; i++)
            {
                ...
                else if ((string)lexTable.Rows[i].Cells[1].Value == "YES")
                {
                    builder.Append(" true ");
                }
                else if ((string)lexTable.Rows[i].Cells[1].Value == "NO")
                {
            ...
            if (results.Errors.Count > 0)
            {
                for (int errNum = 0; errNum < results.Errors.Count; errNum++)
                {
                    ...
                    else if (errorMessage.Equals("Argument 1: cannot convert type 'int' to 'float'"))
                    {
                        errorMessage2 = "cannot convert type 'WHOLE' to 'FRACTION'";
                    }
                    else if (errorMessage.Equals("Argument 1: cannot convert type 'int' to 'char'"))
                    {
                        errorMessage2 = "cannot convert type 'WHOLE' to 'SYMBOL'";
                    }
                    else if (errorMessage.Equals("Argument 1: cannot convert type 'int' to 'string'"))
                    {
                        errorMessage2 = "cannot convert type 'WHOLE' to 'PHRASE'";
                    }
                    else if (errorMessage.Equals("Argument 1: cannot convert type 'int' to 'bool'"))
                    {
                        errorMessage2 = "cannot convert type 'WHOLE' to 'CHOICE'";
                    }
                    else if (errorMessage.Equals("Argument 1: cannot convert type 'float' to 'int'"))
                    {
                        errorMessage2 = "cannot convert type 'FRACTION' to 'WHOLE'";
                    }
                    else if (errorMessage.Equals("Argument 1: cannot convert type 'float' to 'char'"))
                    {
                        errorMessage2 = "cannot convert type 'FRACTION' to 'SYMBOL'";
                    }
                    else if (errorMessage.Equals("Argument 1: cannot convert type 'float' to 'string'"))
                    {
                        errorMessage2 = "cannot convert type 'FRACTION' to 'PHRASE'";
                    }
                    else if (errorMessage.Equals("Argument 1: cannot convert type 'float' to 'bool'"))
                    {
                        errorMessage2 = "cannot convert type 'FRACTION' to 'CHOICE'";
                    }
                    else if (errorMessage.Equals("Argument 1: cannot convert type 'char' to 'int'"))
                    {
                        errorMessage2 = "cannot convert type 'SYMBOL' to 'WHOLE'";
                    }
                    else if (errorMessage.Equals("Argument 1: cannot convert type 'char' to 'float'"))
                    {
                        errorMessage2 = "cannot convert type 'SYMBOL' to 'FRACTION'";
                    }
                    else if (errorMessage.Equals("Argument 1: cannot convert type 'char' to 'string'"))
                    {
                        errorMessage2 = "cannot convert type 'SYMBOL' to 'PHRASE'";
                    }
                    else if (errorMessage.Equals("Argument 1: cannot convert type 'char' to 'bool'"))
                    {
                        errorMessage2 = "cannot convert type 'SYMBOL' to 'CHOICE'";
                    }
                    else if (errorMessage.Equals("Argument 1: cannot convert type 'string' to 'int'"))
                    {
                        errorMessage2 = "cannot convert type 'PHRASE' to 'WHOLE'";
                    }
                    else if (errorMessage.Equals("Argument 1: cannot convert type 'string' to 'float'"))
                    {
                        errorMessage2 = "cannot convert type 'PHRASE' to 'FRACTION'";
                    }
                    else if (errorMessage.Equals("Argument 1: cannot convert type 'string' to 'char'"))
                    {
                        errorMessage2 = "cannot convert type 'PHRASE' to 'SYMBOL'";
                    }
                    else if (errorMessage.Equals("Argument 1: cannot convert type 'string' to 'bool'"))
                    {
                        errorMessage2 = "cannot convert type 'PHRASE' to 'CHOICE'";
                    }
                    else if (errorMessage.Equals("Argument 1: cannot convert type 'bool' to 'int'"))
                    {
                        errorMessage2 = "cannot convert type 'CHOICE' to 'WHOLE'";
                    }
                    else if (errorMessage.Equals("Argument 1: cannot convert type 'bool' to 'float'"))
                    {
                        errorMessage2 = "cannot convert type 'CHOICE' to 'FRACTION'";
                    }
                    else if (errorMessage.Equals("Argument 1: cannot convert type 'bool' to 'char'"))
                    {
                        errorMessage2 = "cannot convert type 'CHOICE' to 'SYMBOL'";
                    }
                    else if (errorMessage.Equals("Argument 1: cannot convert type 'bool' to 'string'"))
                    {
                        errorMessage2 = "cannot convert type 'CHOICE' to 'PHRASE'";
                    }
