    ...
    public class SemanticsAnalyzer
    {
        public void start(Compilourdes_GUI cmp, DataGridView lexTable, string txtCode1)
        {
            ...
            for (int i = 0; i < lexTable.Rows.Count; i++)
            {
                ...
                else if ((string)lexTable.Rows[i].Cells[1].Value == "CONTINUE")
                {
                ...
                else if ((string)lexTable.Rows[i].Cells[1].Value == "}")
                {
                    ...
                    {
                        functionFound = false;
                        builder.Append(" Console.ReadLine(); }catch(Exception e){/*Console.WriteLine(\"Error: \" + e.ToString());*/ Console.ReadLine();}} ");
                ...
                else if ((string)lexTable.Rows[i].Cells[1].Value == "id")
                {
                    ...
                    if (inputFound)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                inputBody = " = float.Parse(Console.ReadLine() ";
                            }
                            else if (charList.Contains((string)lexTable.Rows[i].Cells[0].Value))
                            {
                    ...
                    else if ((string)lexTable.Rows[i + 1].Cells[1].Value == "[")
                    {
                        ...
                        if (declarationFound)
                        {
                            ...
                            {
                                if ((string)lexTable.Rows[i].Cells[3].Value == "Param")
                                {
            ...
            if (results.Errors.Count > 0)
            {
                for (int errNum = 0; errNum < results.Errors.Count; errNum++)
                {
                    ...
                    errorMessage2 = errorMessage2.Replace(" if ", "TEST");
                    errorMessage2 = errorMessage2.Replace(" bool ", "CHOICE");
                    errorMessage2 = errorMessage2.Replace(" break ", "BREAK");
                    errorMessage2 = errorMessage2.Replace(" continue ", "CONTINUE");
                    //errorMessage = errorMessage.Replace(" double ", " FRACTION ");
                    errorMessage2 = errorMessage2.Replace("'int'", "WHOLE");
                    errorMessage2 = errorMessage2.Replace("'float'", "FRACTION");
                    errorMessage2 = errorMessage2.Replace("'char'", "SYMBOL");
                    errorMessage2 = errorMessage2.Replace("'string'", "PHRASE");
                    errorMessage2 = errorMessage2.Replace("'void'", "EMPTY");
                    errorMessage2 = errorMessage2.Replace(" const ", "CONSTRUCT");
                    errorMessage2 = errorMessage2.Replace(" struct ", "GROUP");
                    //errorMessage = errorMessage.Replace(" double ", " MIRROR ");
                    errorMessage2 = errorMessage2.Replace(" else ", "THEN");
                    errorMessage2 = errorMessage2.Replace(" switch ", "EXAMINE");
                    errorMessage2 = errorMessage2.Replace(" case ", "PICK");
                    errorMessage2 = errorMessage2.Replace(" break ", "BREAK");
                    errorMessage2 = errorMessage2.Replace(" default ", "DECIDE");
                    errorMessage2 = errorMessage2.Replace(" for ", "EXECUTE");
                    errorMessage2 = errorMessage2.Replace(" while ", "UNTIL");
                    errorMessage2 = errorMessage2.Replace(" do ", "WORK");
                    errorMessage2 = errorMessage2.Replace(" true ", "YES");
                    errorMessage2 = errorMessage2.Replace(" false", "NO");
                    errorMessage2 = errorMessage2.Replace(" return ", "RETURN");
                    errorMessage2 = errorMessage2.Replace("An explicit conversion exists (are you missing a cast?)", "");
                    errorMessage2 = errorMessage2.Replace("implicitly ", "");
                    if (errorMessage2.Contains("expected"))
                    {
